...
@section('Contenido')
    <form action="{{ route('tipoemp.create') }}" method="post">
        ...
        @csrf
        <h1 class="modal-title fs-5" id="modalRegistrarpais">Registrar Nuevo Tipo de Empleadobbb</h1>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Tipo de empleado</label>
            <input type="text" class="form-control" id="texttipoemp" name="texttipoemp">
