                  ...
                  <tbody>
                    @foreach ( $datos as $items)
                      ...
                      <td class="col-auto">
                        ...
                        <div>
                          <td><a href="{{route('modificarmaterial',$items->id_mat)}}"><button type="sudmit" class="btn btn-secondary">Modificar</button> </a> </td>
                       
                          <td><a href="{{route("material.delete", $items->id_mat)}}"><button type="sudmit" class="btn btn-secondary">Eliminar</button> </a> </td>
                        </div>
                      </tr>
                    @endforeach
                  </tbody>
