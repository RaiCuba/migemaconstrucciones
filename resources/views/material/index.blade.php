...
<a href="{{ route("formulariomaterial") }}"><button type="sudmit" class="btn btn-outline-dark">Registrar Nuevo material</button> </a>
                  ...
                  <tbody>
                    @foreach ( $datos as $items)
                      ...
                      <td class="col-auto">
                        ...
                        <div>
                          <td><a href="{{route('modificarmaterial',$items->id_mat)}}"><button type="sudmit" class="btn btn-outline-dark">Modificar</button> </a> </td>
                       
                          <td><a href="{{route("material.delete", $items->id_mat)}}"><button type="sudmit" class="btn btn-outline-dark">Eliminar</button> </a> </td>
                        </div>
                      </tr>
                    @endforeach
                  </tbody>
