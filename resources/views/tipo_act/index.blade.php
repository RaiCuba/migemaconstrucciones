                  ...
                  <tbody>
                    @foreach ( $datos as $items)
                      <tr>
                        ...
                        <div>
                          <td><a href="{{route('modificartipoact', $items->id_tip_act)}}"><button type="sudmit" class="btn btn-secondary">Modificar</button> </a> </td>
                       
                          <td><a href="{{route("tipoact.delete", $items->id_tip_act)}}"><button type="sudmit" class="btn btn-secondary">Eliminar</button> </a> </td>
                        </div>
                      </tr>
                    @endforeach
                  </tbody>
