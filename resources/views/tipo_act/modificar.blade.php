...
@section('Contenido')
    ...
    <!--se requiere este para ralaval para que funciones-->
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="textid" name="textid" required value="{{ $tipoact->id_tip_act }}">
                <div id="emailHelp" class="form-text"></div>
              </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Tipo de Actividad</label>
                <input type="text" class="form-control" id="texttipoact" name="texttipoact" required value="{{ $tipoact->nombre }}">
                <div id="emailHelp" class="form-text"></div>
              </div>
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Tipo de empleado</label>
                <input type="text" class="form-control" id="textdescrip" name="textdescrip" required value="{{ $tipoact->descrip }}">
                <div id="emailHelp" class="form-text"></div>
              </div>
