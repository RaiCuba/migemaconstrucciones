...
<a href="{{ route("formulariociudad") }}"><button type="sudmit" class="btn btn-secondary">Nueva Ciudad</button> </a>
                  ...
                  <tbody>
                    @foreach ( $datos as $items)
                      <tr>
                        ...
                        <div>
                          <td><a href="{{route("modificarciudad", $items->id_ciu)}}"><button type="sudmit" class="btn btn-secondary">Modificar</button> </a> </td>
