                  ...
                  <tbody>
                    @foreach ( $datos as $items)
                      <tr>
                        ...
                        <div>
                          <td><a href="{{route('modificarproveedor',$items->id_prov)}}"><button type="sudmit" class="btn btn-outline-dark">Modificar</button> </a> </td>
                       
                          <td><a href="{{route("proveedor.delete", $items->id_prov)}}"><button type="sudmit" class="btn btn-outline-dark">Eliminar</button> </a> </td>
                        </div>
                      </tr>
                    @endforeach
                  </tbody>
