                  ...
                  <tbody>
                    ...
                    <td class="col-auto">
                      <p class=" mb-0">{{$items->estado }}</p>
                        ...
                        <div>
                          <td><a href="{{route("modificaract", $items->id_act)}}"><button type="sudmit" class="btn btn-secondary">Modificar</button> </a> </td>
                       
                          <td><a href="{{route("act.delete", $items->id_act)}}"><button type="sudmit" class="btn btn-secondary">Eliminar</button> </a> </td>
                        </div>
                      </tr>
                    @endforeach
                  </tbody>
