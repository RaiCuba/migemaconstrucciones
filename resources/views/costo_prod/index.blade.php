...
@section('Contenido')
    ...
    <a href="{{ route('formulariocostoprod') }}"><button type="sudmit" class="btn btn-outline-dark">Nuevo Costo de
            producto</button> </a>
                    ...
                    <tbody>
                        @foreach ($datos as $items)
                            <tr>
                                ...
                                <div>
                                    <td><a href="{{ route('modificarcostoprod', $items->id_cos_pro) }}"><button
