                  ...
                  <tbody>
                    ...
                    <td class="col-auto">
                      <p class=" mb-0">{{ $items->fecha}}</p>
                        ...
                        <div>
                          <td><a href="{{route("modificarcostoprod", $items->id_cos_pro)}}"><button type="sudmit" class="btn btn-outline-dark">Modificar</button> </a> </td>
                       
                          <td><a href="{{route("costoprod.delete", $items->id_cos_pro)}}"><button type="sudmit" class="btn btn-outline-dark">Eliminar</button> </a> </td>
                        </div>
                      </tr>
                    @endforeach
                  </tbody>
