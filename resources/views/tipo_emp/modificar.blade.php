...
@section('Contenido')
    ...
    <!--se requiere este para ralaval para que funciones-->
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="textid" name="textid" required value="{{ $tipoemp->id_tip_emp }}">
                <div id="emailHelp" class="form-text"></div>
              </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Tipo de empleado</label>
                <input type="text" class="form-control" id="texttipoemp" name="texttipoemp" required value="{{ $tipoemp->nombre }}">
                <div id="emailHelp" class="form-text"></div>
              </div>
